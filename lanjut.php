...
<body style="background-color: #151719;">
    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a class="nav-link" href="loginadmin.php">Riwayat User</a>
          </li>
          <li class="nav-item">
  ...
  <div class="container text-center mt-3 container-sm container-md ">
      ...
      <div class="col-xl-4 col-4 animate__animated animate__bounceInUp animate__slow">
        <div class="card foto-1 me-5" style="width: 15rem;">
          ...
          <div class="card-body bg-costum1">
            ...
            <a href="https://www.instagram.com/p/CAqC7ivAyQY/?utm_source=ig_web_copy_link" class="btn btn-primary">look
              at instagram</a>
          </div>
        </div>
      </div>
      <div class="col-xl-4 col-12 mt-mobile-2 animate__animated animate__bounceInUp">
        <div class="card foto-1" style="width: 15rem;">
          ...
          <div class="card-body bg-costum1">
            ...
            <a href="https://www.instagram.com/p/CA7dcgrAJit/?utm_source=ig_web_copy_link" class="btn btn-primary">look
              at instagram</a>
          </div>
        </div>
      </div>
      <div class="col-xl col-12 mt-mobile-2 mt-tablet-2 animate__animated animate__bounceInUp animate__fast">
        <div class="card " style="width: 15rem;">
          ...
          <div class="card-body bg-costum1">
            ...
            <a href="https://www.instagram.com/p/B_EvFcWgzmM/?utm_source=ig_web_copy_link" class="btn btn-primary">look
              at instagram</a>
          </div>
        </div>
      </div>
    ...
    <!-- keterangan foto -->
    <div class="row mt-3 me-3 animate__animated animate__bounceInRight">
      <div class="col me-mobile-7">
        <button class="btn btn-primary d-flex justify-content-center align-items-center" type="button" data-bs-toggle="collapse" data-bs-target="#collapseExample"
          aria-expanded="false" aria-controls="collapseExample">
          keterangan Foto
        </button>
      </div>
      <div class="collapse" id="collapseExample">
        <div class="card card-body" style="background-color: rgba(255, 255, 255, 0.155);">
          <p>Foto diatas saya edit menggunakan phonto dan adobe lightroom dan juga saya sudah saya upload di instagram
          </p>
        </div>
      </div>
    </div>
    <!-- layout ke vidio -->
    <div class="row mt-4 me-3 animate__animated animate__bounceInUp animate__slower">
      ...
      <!-- keterangan vidio -->
      <div class="row mt-2 me-3 animate__animated animate__bounceInRight animate__slower">
        <div class="col me-mobile-7 ">
          <button class="btn btn-primary d-flex justify-content-center align-items-center" type="button" data-bs-toggle="collapse" data-bs-target="#vidio"
            aria-expanded="false" aria-controls="collapseExample">
            keterangan vidio
          </button>
        </div>
        <div class="collapse" id="vidio">
          <div class="card card-body" style="background-color: rgba(255, 255, 255, 0.155);">
            <p>vido diatas saya edit dengan sebuah website 3D, namanya <a href="panzoid.com">panzoid</a>
            </p>
          </div>
        </div>
      </div>
